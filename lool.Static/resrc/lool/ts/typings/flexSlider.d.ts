...
interface SliderObject { //Object: The slider element itself
    ...
    direction: string;            //String: The slider direction
    ...
    addSlide(obj, pos?: number);    //Function: Add one slide at the position to the slider - (obj, pos) parameters
    removeSlide(pos: number);       //Function: Remove one slide at the postion - (pos) parameter
}
